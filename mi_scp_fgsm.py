...
tf.flags.DEFINE_string('output_dir', './test',
...
def graph_inception_v3(x, y, i, x_max, x_min, grad):
...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        x_adv, _, _, _, _, _ = tf.while_loop(stop, graph_inception_v3, [x_input, y, i, x_max, x_min, grad])

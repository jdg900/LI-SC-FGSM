...
def input_mix_resize_uni(input_tensor):
    ...
    #start_x1 = tf.random_uniform((), 0, FLAGS.image_width - patch_size, dtype=tf.int32)
    #start_y1 = tf.random_uniform((), 0, FLAGS.image_height - patch_size, dtype=tf.int32)
    ...
    #patch1 = tf.image.crop_to_bounding_box(input_tensor, start_y1, start_x1, patch_size, patch_size)
